...
<div class="container">
            <form method="post" action="{{route('cost.update',$cost->id)}}"class="form-horizontal" role="form">
            @csrf
@if($errors->any())
...
@endif
                    ...
                    <div class="col-sm-9">
                        <select type="text" name="type_id" class="form-control" autofocus>
                            ...
                            @foreach($slot_types as $type)
                                <option value="{{$type->id}}" {{$type->id==$cost->type_id ? 'selected':''}}>{{$type->name}}</option>
                            @endforeach
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="cost" value="{{$cost->cost}}"type="text" id="cost"  class="form-control" autofocus>
                    </div>
