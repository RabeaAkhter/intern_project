...
<div class="container">
            <form method="post" action="{{route('slotype.update',$type->id)}}"class="form-horizontal" role="form">
            @csrf
@if($errors->any())
...
@endif
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input name="slotname" value="{{$type->name}}" type="text" id="slotName"  class="form-control" autofocus>
                    </div>
                </div>
                <div class="form-group">
